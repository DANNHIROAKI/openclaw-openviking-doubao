...
- OpenViking official OpenClaw plugin snapshot from `volcengine/OpenViking` `v0.3.6` (`examples/openclaw-plugin/`)
...
- OpenClaw core is **not vendored in full** here. The default path in this repository installs OpenClaw from the npm stable channel, pinned to `2026.4.12` for reproducibility.
